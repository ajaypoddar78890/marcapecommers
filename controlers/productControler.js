...
export const creatProductcontroll = async (req, res) => {
  try {
...
export const singleproductcontroller = async (req, res) => {
  try {
    ...
    res.status(200).send({
      succes: true,
      message: "got single product succesfully",
      product,
    });
  } catch (error) {
    console.log(error);
...
// update product
export const updateProductcontroll = async (req, res) => {
  try {
    const { name, description, price, category, quantity, shipping } =
      req.fields;
    const { photo } = req.files;
...
export const filterbyProduct = async (req, res) => {
  try {
